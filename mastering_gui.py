# mastering_gui.py (v3.6 - Feature Branch: AI Tagger)
# This is the final version, completing the integration with new UI controls.
# It adds a checkbox for auto-generation and a display for AI analysis results.
...
# Use the correct, final engine name
...
class MasteringApp(ThemedTk):
    def __init__(self):
        ...
        self.title("Audio Mastering Suite v3.6 (AI Enhanced)")
        self.geometry("800x1100") # Increased height for new controls
        ...
        self.auto_generate_prompt = tk.BooleanVar(value=False) # <-- New control variable
        ...
        ttk.Label(art_header_frame, text="AI Cover Art Generation", style="Header.TLabel").grid(row=0, column=0, sticky='w')
    ...
    def update_tag_display(self, message):
        self.tag_label.config(text=f"Studio Notes: {message}")

    # --- Other helper and callback methods are unchanged ---
    ...
    def update_status(self, message):
        ...
        if "Success:" in message or "Error:" in message or "Failed:" in message:
            ...
            if "Success:" in message:
                messagebox.showinfo("Success", "Your audio file has been processed successfully!")
    ...
    def update_art_display(self, image_path):
        ...
        try:
            ...
            frame_width = self.art_display_frame.winfo_width() or 400
            frame_height = self.art_display_frame.winfo_height() or 400
